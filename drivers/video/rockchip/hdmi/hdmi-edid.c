...
*/	mode->right_margin = H_SYNC_OFFSET;
	...
	hdmi_edid_debug("%d KHz Refresh %d Hz",
...
/*	hdmi_edid_debug("[EDID-CEA] ddc_offset %d underscan_support %d
...
*/	/* Parse data block */
	while (cur_offset < ddc_offset) {
		...
		case 0x07:	/* Use Extended Tag */
			...
			break;
		default:
			pr_err("[EDID-CEA] unkowned data block tag.\n");
			break;
		}
